          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:your.email@example.com" className="text-blue-600 hover:text-blue-700">your.email@example.com</a>
                </div>
              </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex gap-4">
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-gray-200 hover:bg-blue-100 flex items-center justify-center transition-colors">
                ...
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-gray-200 hover:bg-blue-100 flex items-center justify-center transition-colors">
                  <svg className="w-6 h-6 text-gray-700 hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-gray-200 hover:bg-blue-100 flex items-center justify-center transition-colors">
                  <svg className="w-6 h-6 text-gray-700 hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24">
